...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    #[ORM\OneToMany(mappedBy: 'id_user', targetEntity: ResultatQuizz::class, orphanRemoval: true)]
    ...
    public function removeResultatQuizz(ResultatQuizz $resultatQuizz): self
    {
        if ($this->resultatQuizzs->removeElement($resultatQuizz)) {
            ...
            if ($resultatQuizz->getIdUser() === $this) {
                $resultatQuizz->setIdUser(null);
            }
        }
